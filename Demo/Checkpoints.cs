...
namespace Script
{
    ...
    public partial class WorkFlowScript
    {
        ...
        private void set_StServiceCallActivity11_checkpoints(STActivityBase activity)
        {
            VTDPropertyInfoBase stracturalOutputEnvelope = new VTDPropertyInfoBase("OutputEnvelope", "/*[local-name(.)=\'Envelope\'][1]");
            IList<VTDPropertyInfoBase> stracturalPropsInfo = new List<VTDPropertyInfoBase>();
            CpValObj ExpectedSchema = new CpValObj("<?xml version=\"1.0\" encoding=\"utf-16\"?><xs:schema xmlns=\"http://schemas.xmlsoap.o" +
        ...
        private void set_StServiceCallActivity12_checkpoints(STActivityBase activity)
        {
            ...
            // Checkpoint 2
            IVTDGetter actualValueGetter2 = new VTDXPathGetter(new VTDPropertyInfoBase("OutputEnvelope", "/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightOrdersResponse'][1]/*[local-name(.)='GetFlightOrdersResult'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='Class'][1]"), XmlTypeCode.String, false);
            IVTDSetter actualValueSetter2 = new VTDCheckpointSetter(XmlTypeCode.String);
            BindDirection actualBindDirection2 = new BindDirection(_flow.StServiceCallActivity12, actualValueGetter2, actualValueSetter2);
            CpValObj valueActualObject2 = new CpValObj(actualBindDirection2, XmlTypeCode.String, false);


            CpValObj valueExpectedObject2 = new CpValObj("{Step.InputProperties.StServiceCallActivity11.Body.CreateFlightOrder.FlightOrder." +
                    "Class}", bind_dir100);
            ValueCPRule cpRule2 = new ValueCPRule(valueActualObject2, valueExpectedObject2, StringCP.EqualTo, "=", false);

            // Checkpoint 3
            IVTDGetter actualValueGetter3 = new VTDXPathGetter(new VTDPropertyInfoBase("OutputEnvelope", "/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightOrdersResponse'][1]/*[local-name(.)='GetFlightOrdersResult'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='CustomerName'][1]"), XmlTypeCode.String, false);
            IVTDSetter actualValueSetter3 = new VTDCheckpointSetter(XmlTypeCode.String);
            BindDirection actualBindDirection3 = new BindDirection(_flow.StServiceCallActivity12, actualValueGetter3, actualValueSetter3);
            CpValObj valueActualObject3 = new CpValObj(actualBindDirection3, XmlTypeCode.String, false);


            CpValObj valueExpectedObject3 = new CpValObj("{DataSource.Customers.Name}", bind_dir101);
            ValueCPRule cpRule3 = new ValueCPRule(valueActualObject3, valueExpectedObject3, StringCP.EqualTo, "=", false);

            // Checkpoint 4
            IVTDGetter actualValueGetter4 = new VTDXPathGetter(new VTDPropertyInfoBase("OutputEnvelope", "/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightOrdersResponse'][1]/*[local-name(.)='GetFlightOrdersResult'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='FlightNumber'][1]"), XmlTypeCode.Int, false);
            IVTDSetter actualValueSetter4 = new VTDCheckpointSetter(XmlTypeCode.Int);
            BindDirection actualBindDirection4 = new BindDirection(_flow.StServiceCallActivity12, actualValueGetter4, actualValueSetter4);
            CpValObj valueActualObject4 = new CpValObj(actualBindDirection4, XmlTypeCode.Int, false);


            CpValObj valueExpectedObject4 = new CpValObj(bind_dir102);
            ValueCPRule cpRule4 = new ValueCPRule(valueActualObject4, valueExpectedObject4, PrimitiveTypeCP.EqualTo, "=", false);

            // Checkpoint 5
            IVTDGetter actualValueGetter5 = new VTDXPathGetter(new VTDPropertyInfoBase("OutputEnvelope", "/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightOrdersResponse'][1]/*[local-name(.)='GetFlightOrdersResult'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='NumberOfTickets'][1]"), XmlTypeCode.Int, false);
            IVTDSetter actualValueSetter5 = new VTDCheckpointSetter(XmlTypeCode.Int);
            BindDirection actualBindDirection5 = new BindDirection(_flow.StServiceCallActivity12, actualValueGetter5, actualValueSetter5);
            CpValObj valueActualObject5 = new CpValObj(actualBindDirection5, XmlTypeCode.Int, false);


            CpValObj valueExpectedObject5 = new CpValObj(bind_dir103);
            ValueCPRule cpRule5 = new ValueCPRule(valueActualObject5, valueExpectedObject5, PrimitiveTypeCP.EqualTo, "=", false);

            // Checkpoint 6
            IVTDGetter actualValueGetter6 = new VTDXPathGetter(new VTDPropertyInfoBase("OutputEnvelope", "/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightOrdersResponse'][1]/*[local-name(.)='GetFlightOrdersResult'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='OrderNumber'][1]"), XmlTypeCode.Int, false);
            IVTDSetter actualValueSetter6 = new VTDCheckpointSetter(XmlTypeCode.Int);
            BindDirection actualBindDirection6 = new BindDirection(_flow.StServiceCallActivity12, actualValueGetter6, actualValueSetter6);
            CpValObj valueActualObject6 = new CpValObj(actualBindDirection6, XmlTypeCode.Int, false);


            CpValObj valueExpectedObject6 = new CpValObj(bind_dir104);
